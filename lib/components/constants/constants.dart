...
// const String serverURL = "https://elyeter.market";
...
const Color kPrimaryColor = Color(0xff55b539);
...
const String normsProSemiBold = "NormsProMedium";
const String normsProBold = "NormsProBold";
//Language icons
const String tmIcon = "assets/lang/tm.png";
const String ruIcon = "assets/lang/ru.png";

const String noComment = 'assets/lottie/NoComment.json';
const String noConnection = 'assets/lottie/noconnection.json';
const String loading2 = 'assets/lottie/loading2.json';
const String searchNotFound = 'assets/lottie/searchNotFound.json';
const String searchinLoader = 'assets/lottie/searchinLoader.json';
